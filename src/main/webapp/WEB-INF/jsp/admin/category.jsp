...
<title>æ ç® - å¼æ¸è½©åå®¢ç®¡çç³»ç»</title>
...
<section class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <div class="row">
        <div class="col-md-5">
          <h1 class="page-header">æ·»å </h1>
          <form action="/Category/add" method="post" autocomplete="off">
            <div class="form-group">
              <label for="category-name">æ ç®åç§°</label>
              <input type="text" id="category-name" name="name" class="form-control" placeholder="å¨æ­¤å¤è¾å¥æ ç®åç§°" required autocomplete="off">
              <span class="prompt-text">è¿å°æ¯å®å¨ç«ç¹ä¸æ¾ç¤ºçåå­ã</span> </div>
            <div class="form-group">
              <label for="category-alias">æ ç®å«å</label>
              <input type="text" id="category-alias" name="alias" class="form-control" placeholder="å¨æ­¤å¤è¾å¥æ ç®å«å" required autocomplete="off">
            ...
            <div class="form-group">
              ...
              <input type="text" id="category-keywords" name="keywords" class="form-control" placeholder="å¨æ­¤å¤è¾å¥æ ç®å³é®å­" autocomplete="off">
            ...
            <button class="btn btn-primary" type="submit" name="submit">æ·»å æ°æ ç®</button>
          </form>
        </div>
        <div class="col-md-7">
          <h1 class="page-header">ç®¡ç <span class="badge">3</span></h1>
          <div class="table-responsive">
            <table class="table table-striped table-hover">
              <thead>
                <tr>
                  <th><span class="glyphicon glyphicon-paperclip"></span> <span class="visible-lg">ID</span></th>
                  <th><span class="glyphicon glyphicon-file"></span> <span class="visible-lg">åç§°</span></th>
                  <th><span class="glyphicon glyphicon-list-alt"></span> <span class="visible-lg">å«å</span></th>
                  <th><span class="glyphicon glyphicon-pushpin"></span> <span class="visible-lg">æ»æ°</span></th>
              ...
              <tbody>
                <tr>
                  ...
                  <td>web</td>
                  <td>125</td>
                  <td><a href="update-category.html">ä¿®æ¹</a> <a rel="1">å é¤</a></td>
                </tr>
                <tr>
                  <td>2</td>
                  <td>åç«¯ç¨åº</td>
                  <td>program</td>
                  <td>185</td>
                  <td><a href="update-category.html">ä¿®æ¹</a> <a rel="2">å é¤</a></td>
                </tr>
                <tr>
                  <td>3</td>
                  <td>ç®¡çç³»ç»</td>
                  <td>cms</td>
                  <td>223</td>
                  <td><a href="update-category.html">ä¿®æ¹</a> <a rel="3">å é¤</a></td>
                </tr>
                <tr>
                  <td>4</td>
                  <td>æäººä»¥æ¸</td>
                  <td>tutorial</td>
                  <td>12</td>
                  <td><a href="update-category.html">ä¿®æ¹</a> <a rel="4">å é¤</a></td>
                </tr>
                <tr>
                  <td>5</td>
                  <td>ç¨åºäººç</td>
                  <td>code</td>
                  <td>35</td>
                  <td><a href="update-category.html">ä¿®æ¹</a> <a rel="5">å é¤</a></td>
                </tr>
              </tbody>
            </table>
            <span class="prompt-text"><strong>æ³¨ï¼</strong>å é¤ä¸ä¸ªæ ç®ä¹ä¼å é¤æ ç®ä¸çæç« åå­æ ç®,è¯·è°¨æå é¤!</span> </div>
        </div>
      </div>
    </div>
  </div>
