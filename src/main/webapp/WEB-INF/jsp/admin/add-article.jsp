        ...
        <form action="/article/add" method="post" class="add-article-form">
          <div class="col-md-9">
            ...
            <div class="form-group">
              ...
              <input type="text" id="article-title" name="artTitle" class="form-control" placeholder="在此处输入标题" required autofocus autocomplete="off">
            </div>
            <!-- <div class="form-group">
            ...
            <div class="form-group">
              ...
              <th><textarea style="width:800px;height:400px;visibility:hidden;" name="artContent"></textarea></th>
            </div>
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
              	<textarea class="form-control" name="artDesc" autocomplete="off"></textarea>
          ...
          <div class="col-md-3">
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                  ...
                  <input type="hidden" name="artImage" /> 
...
$('#addArticleBtn').click(function() {
	//alert("咦提交")
	itemAddEditor.sync();
	alert($(".add-article-form").serialize());
	$.ajax({
        //几个参数需要注意一下
            type: "POST",//方法类型
            dataType: "json",//预期服务器返回的数据类型
            url: "${pageContext.request.contextPath }/article/add" ,//url
	...
	$.post(
		    ...
		    function(data) {
		    	...
		    	for(var i=0;i<data.length;i++) {
		            ...
		            content+="<li> <label><input name='artCtgId' type='radio' value='"+data[i].ctgId+"'>"
...
$(function () {
    ...
    _uploadEditor.ready(function () {
        ...
        //侦听文件上传，取上传文件列表中第一个上传的文件的路径"E:/java后半段/【阶段16】商城项目/商城_day05/e3商城_day05/项目二_day05/source/e3-manager-web/src/main/webapp/WEB-INF/jsp/item-add.jsp"
